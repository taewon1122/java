...
# 회원 상태를 추가하는 쿼리(이용중, 기간정지, 영구정지, 탈퇴)
...
INSERT INTO BOARD(BO_CO_NUM, BO_ME_ID, BO_TITLE, BO_CONTENT)
SELECT 2, 'admin', '공지사항', '공지사항 입니다.' FROM COMMUNITY WHERE CO_NAME = '공지';
...
# qwe123회원이 1번 게시글의 추천 버튼을 클릭 했을 때 실행되는 쿠러ㅣ
# 1. qwe123회원이 1번 게시글에 추천한 기록을 조회.
SELECT * FROM RECOMMEND WHERE RE_ME_ID = 'qwe213' AND RE_BO_NUM = 1;
