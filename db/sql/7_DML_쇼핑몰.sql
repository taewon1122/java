...
UPDATE CATEGORY SET CA_NAME = "의류" WHERE CA_NUM = 2;
...
SELECT * FROM PRODUCT;
# 카테고리 : 전자제품, 의류, 식품, 자동차
INSERT INTO CATEGORY(CA_NAME) VALUES("전자제품"), ("식품"), ("자동차");
/*
코드 : ABC002, 제품명 : 볼펜, 내용 : 모나미 볼펜, 가격 : 1000, 카테고리 : 기타1
코드 : ABC003, 제품명 : 지우개, 내용 : 잘지워지는 지우개, 가격 : 500, 카테고리 : 기타1
코드 : ELC001, 제품명 : 마우스, 내용 : 무선 마우스, 가격 : 10000, 카테고리 : 전자제품3
코드 : ELC002, 제품명 : 키보드, 내용 : 무선 키보드, 가격 : 50000, 카테고리 : 전자제품3
코드 : CLO001, 제품명 : 모자, 내용 : 좋은 모자, 가격 : 10000, 카테고리 : 의류2
코드 : CLO002, 제품명 : 셔츠, 내용 : 구김이 없는 셔츠, 가격 : 50000, 카테고리 : 의류2
코드 : FOO001, 제품명 : 만두, 내용 : 고기만두, 가격 : 10000, 카테고리 : 식품4
코드 : FOO002, 제품명 : 라면, 내용 : 맛있는 라면, 가격 : 3000, 카테고리 : 식품4
코드 : CAR001, 제품명 : 방향제, 내용 : 향기 좋음, 가격 : 5000, 카테고리 : 자동차5
*/
INSERT INTO PRODUCT VALUES("ABC002", "볼펜", "모나미 볼펜", 1000, 1);
INSERT INTO PRODUCT VALUES("ABC003", "지우개", "잘지워지는 지우개", 500, 1);
INSERT INTO PRODUCT VALUES("ELC001", "마우스", "무선 마우스", 10000, 3);
INSERT INTO PRODUCT VALUES("ELC002", "키보드", "무선 키보드", 50000, 3);
INSERT INTO PRODUCT VALUES
("CLO001", "모자", "좋은 모자", 10000, 2),
("CLO002", "셔츠", "구김이 없는 셔츠", 50000, 2),
("FOO001", "만두", "고기 만두", 10000, 4),
("FOO002", "라면", "맛있는 라면", 30000, 4),
