...
public class InitEx1 {
	...
	public static void main(String[] args) {
		...
		//num3은 int의 기본값으로 초기화 => 명시적 초기화로 덮어
		System.out.println(b.num3);
		//num4은 int의 기본값으로 초기화 => 명시적 초기화로 덮어
		System.out.println(B.num4);
		//num5는 기본값 0 -> 명시적초기화 10 -> 초기화블록 2
		System.out.println(b.num5);
		//num5는 기본값 0 -> 명시적초기화 20 -> 초기화블록 4
		System.out.println(B.num6);
		//num7은 기본값 -> 명시적초기화 30 -> 초기화블록 500 ->생성자 5
