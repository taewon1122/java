...
import day10.word.WordT;

public class ProducttMain {
		private static Scanner scan = new Scanner(System.in);
		private static Productt[] list = new Productt[10];
		private static Productt[] saleList = new Productt[10];
		...
		public static void saleProduct() {
			...
			Productt tmp = new Productt(name, amount, 
		...
		public static void storeProduct() {
			...
			//없으면 추가
			list[count] = new Productt(name, amount, buyPrice, price);
			count++;
		 ...
		 */
		public static Productt[] expandList(Productt[] list) {
			//배열이 꽉차면 배열 확장
			Productt[] tmpList = new Productt[list.length + 10];
