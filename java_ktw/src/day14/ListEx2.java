...
public class ListEx2 {
	...
	public static void main(String[] args) {
		//정수를 5개 입력받아 입력받은 정수를 List에 저장하고 출력하는 코드를 작성하세요.
		
		//함수를 여러개 저장하기 위해 ArrayList 인스턴스를 생성
		//정수이기 때문에 Integer를 추가. int가 안되는 이유는 제레릭은 클래스만 올 수 있어서
		ArrayList<Integer> list = new ArrayList<Integer>();
		//콘솔창에 다양한 값을 입력받기 위한 Scanner 인스턴스르르 생성
		//콘솔창에 입력받아야 하기 때문에 표준 입력인 System.in 인스턴스를 전달
		Scanner scan = new Scanner(System.in);
		//입력받을 정수의 갯수 5개
		int count = 5;
		//System에 있는 out 인스턴스에서 제공하는 print메서드를 이용하여 콘솔창에 문자열을 출력
		System.out.println("정수 5개 입력 : ");
		//i가 count보다(5보다)작을 때 까지. 정수 5개를 입력한다.
		//i는 0부터 4까지 5번 반복
		for(int i = 0; i<count; i++) {
			...
			//int인자 tmp가 integer로 박싱이 되면서 리스트에 추가
			list.add(tmp);
		}
