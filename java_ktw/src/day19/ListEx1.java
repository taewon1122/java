...
public class ListEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - get(번지) : 리스트에서만 제공하는 메서드 -> set은 번지를 통해 접근할 수 없기 때문에
		 */		
		...
		/* list3는 List인터페이스를 구현한 구현 클래스들의 객체중 아무나 올 수 있다.
		 ...
		 * remove(객체) : Collection, 객체와 일치하는 요소를 제거 후 제거여부 반환
		 */
		list5.remove(0);
		list5.remove("def");
