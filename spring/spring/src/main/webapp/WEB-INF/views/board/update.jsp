...
<form action="<c:url value="/board/update"/>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<textarea type="text" class="form-control" id="bo_content" name="bo_content">${board.bo_content}</textarea>
	</div>
	<div class="form-group box-attachment">
		...
		<c:forEach items="${fileList}" var="file">
			<div class="form-control">
				...
				<a href="javacript:void(0);" class="btn-del" data-num="${file.fi_num}">&times;</a>
			</div>
		</c:forEach>
...
$(".btn-del").click(function(){
	...
	//input hidden 삭제한 첨부파일 번호 추가
	$(this).parents(".box-attachment").prepend(`<input type="text" name="delNums">` value="\${num}");
	//input file을 추가
