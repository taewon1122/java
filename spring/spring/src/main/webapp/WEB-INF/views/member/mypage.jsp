...
<form action="<c:url value="/mypage"/>" method="post">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="id" name="me_id" readonly="readonly" value="${user.me_id}">
	...
	<button class="btn btn-outline-success col-12 btn-submit" type="button">내정보 수정</button>
	<div class="box-pw">
